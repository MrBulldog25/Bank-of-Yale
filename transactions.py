...
from sqlalchemy import Column, DECIMAL, Integer, Date, Boolean, ForeignKey
...
class Transaction(Base):
    ...
    _amt = Column(DECIMAL(precision=25, scale=10), nullable=False)
    _date = Column(Date, nullable=False)
    _exempt = Column(Boolean, nullable=False)
    _account_id = Column(Integer, ForeignKey('accounts._account_number'))
